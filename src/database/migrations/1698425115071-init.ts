...
export class Init1698425115071 implements MigrationInterface {
    name = 'Init1698425115071'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."course_schedules_language_enum" AS ENUM('multi_lang', 'ru', 'kk')`);
        await queryRunner.query(`CREATE TABLE "course_schedules" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "date" TIMESTAMP WITH TIME ZONE NOT NULL, "start_time" TIME NOT NULL, "end_time" TIME NOT NULL, "week_day" "public"."course_schedules_week_day_enum" NOT NULL, "room" character varying NOT NULL, "language" "public"."course_schedules_language_enum" NOT NULL DEFAULT 'multi_lang', "coursePublicationId" integer, CONSTRAINT "PK_68118fc569f0c9ebb03fb79f80e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "course_publications" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "start_date" TIMESTAMP WITH TIME ZONE NOT NULL, "end_date" TIMESTAMP WITH TIME ZONE NOT NULL, "price" integer NOT NULL DEFAULT '0', "capacity" integer NOT NULL, "status" "public"."course_publications_status_enum" NOT NULL DEFAULT 'new', "courseId" integer, CONSTRAINT "PK_45269197818fa4c2efb7d6f822a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "course_categories" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, "mpath" character varying DEFAULT '', "parentId" integer, CONSTRAINT "PK_626794960514393da07e942f8d0" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."courses_course_type_enum" AS ENUM('private', 'public_order', 'budget')`);
        await queryRunner.query(`CREATE TABLE "courses" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, "teacher" character varying NOT NULL, "hour_per_week" integer NOT NULL, "course_type" "public"."courses_course_type_enum" NOT NULL DEFAULT 'private', "description" text NOT NULL, "requirements" text NOT NULL, "syllabus" text NOT NULL, "organizationId" integer, "courseCategoryId" integer, CONSTRAINT "PK_3f70a487cc718ad8eda4e6d58c9" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "course_categories" ADD CONSTRAINT "FK_4e6683d208c79d91f87edadf8d5" FOREIGN KEY ("parentId") REFERENCES "course_categories"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "course_categories" DROP CONSTRAINT "FK_4e6683d208c79d91f87edadf8d5"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."course_schedules_language_enum"`);
